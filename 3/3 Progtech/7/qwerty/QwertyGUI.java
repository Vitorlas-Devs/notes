...
public class QwertyGUI {
  ...
  public QwertyGUI() {
    ...
    for (String buttonText : buttonTexts) {
      ...
      switch (buttonText) {
        case "Back" -> b.addActionListener(new BackspaceActionListener());
        case "CLR" -> b.addActionListener(new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            display.setText("");
          }
        });
        default -> b.addActionListener(new QwertyListener(buttonText));
      }
      buttonPanel.add(b);
    }
